        ...
        <div class="mobile clearfix">
            <div class="content">
                ...
                <div class="html instagram">
                    <div class="forms">
                        <form id="form_instagram" action="{{route('informe_actualizado_instagram')}}" method="post" target="_blank">
                            @csrf
                            <h1 class="text-center" style="color:#fff;">Generacion de informe de instagram</h1>
                ...
                <div class="html info_escucha_fechas">
                    <div class="forms">
                        <form id="form_escucha_dates" action="{{route('informe_escucha_fechas_instagram')}}" method="post" target="_blank" enctype="multipart/form-data">
                            @csrf
