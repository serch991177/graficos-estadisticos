...
<body>
    ...
    <div class="page-5" >
        <div style="position:absolute; top:270px; left:350px;">
            <span>Likes : {{$postData['comment_pop']['most_reacted'][0]['like_count'] ?? $postData['comment_pop']['most_reacted'][0]['Likes'] ?? 0}}  Loves : {{$postData['comment_pop']['most_reacted'][0]['love_count'] ?? $postData['comment_pop']['most_reacted'][0]['Loves'] ?? 0}}  Hahas: {{$postData['comment_pop']['most_reacted'][0]['haha_count'] ?? $postData['comment_pop']['most_reacted'][0]['Hahas'] ?? 0}}  Wows: {{$postData['comment_pop']['most_reacted'][0]['wow_count'] ?? $postData['comment_pop']['most_reacted'][0]['Wows'] ?? 0 }} Sads :{{$postData['comment_pop']['most_reacted'][0]['sad_count'] ?? $postData['comment_pop']['most_reacted'][0]['Sads'] ?? 0}} Angries :{{$postData['comment_pop']['most_reacted'][0]['angry_count'] ?? $postData['comment_pop']['most_reacted'][0]['Angries'] ?? 0}}</span>
        </div>
        ...
        <div style="position:absolute; top:620px; left:350px;">
            <span>Likes : {{$postData['comment_pop']['most_reacted'][1]['like_count'] ?? $postData['comment_pop']['most_reacted'][1]['Likes'] ?? 0}}  Loves : {{$postData['comment_pop']['most_reacted'][1]['love_count'] ?? $postData['comment_pop']['most_reacted'][1]['Loves'] ?? 0 }}  Hahas: {{$postData['comment_pop']['most_reacted'][1]['haha_count'] ?? $postData['comment_pop']['most_reacted'][1]['Hahas'] ?? 0}}  Wows: {{$postData['comment_pop']['most_reacted'][1]['wow_count'] ?? $postData['comment_pop']['most_reacted'][1]['Wows'] ?? 0}} Sads :{{$postData['comment_pop']['most_reacted'][1]['sad_count'] ?? $postData['comment_pop']['most_reacted'][1]['Sads'] ?? 0}} Angries :{{$postData['comment_pop']['most_reacted'][1]['angry_count'] ?? $postData['comment_pop']['most_reacted'][1]['Angries'] ?? 0}}</span>
        </div>
        ...
        <div style="position:absolute; top:950px; left:350px;">
            <span>Likes : {{$postData['comment_pop']['most_reacted'][2]['like_count'] ?? $postData['comment_pop']['most_reacted'][2]['Likes'] ?? 0}}  Loves : {{$postData['comment_pop']['most_reacted'][2]['love_count'] ?? $postData['comment_pop']['most_reacted'][2]['Loves'] ?? 0}}  Hahas: {{$postData['comment_pop']['most_reacted'][2]['haha_count'] ?? $postData['comment_pop']['most_reacted'][2]['Hahas'] ?? 0}}  Wows: {{$postData['comment_pop']['most_reacted'][2]['wow_count'] ?? $postData['comment_pop']['most_reacted'][2]['Wows'] ?? 0}} Sads :{{$postData['comment_pop']['most_reacted'][2]['sad_count'] ?? $postData['comment_pop']['most_reacted'][2]['Sads'] ?? 0}} Angries :{{$postData['comment_pop']['most_reacted'][2]['angry_count'] ?? $postData['comment_pop']['most_reacted'][2]['Angries'] ?? 0}}</span>
        </div>
