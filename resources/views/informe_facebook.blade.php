...
<body>
    ...
    <div class="page-6">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesToppost0 !!}</h1></div>
    ...
    @if(isset($datos['TopPost'][1]))
        <div class="page-6">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesToppost1 !!}</h1></div>
    ...
    <div class="page-10">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesTopImpressions0 !!}</h1></div>  
    ...
    @if(isset($datos['topImpressionsPosts'][1]))
        <div class="page-10">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesTopImpressions1 !!}</h1></div>
    ...
    <div class="page-7">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostShared0 !!}</h1></div>  
    ...
    @if(isset($datos['getMostSharedPost'][1]))
        <div class="page-7">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostShared1 !!}</h1></div>
    ...
    <div class="page-8">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostComments0 !!}</h1></div>
    ...
    @if(isset($datos['getMostCommentsPost'][1]))
        <div class="page-8">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:15px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostComments1 !!}</h1></div>
