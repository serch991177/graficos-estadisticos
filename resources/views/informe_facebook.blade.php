...
<body>
    ...
    <div class="page-4">
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center ; position:absolute; top:240px; left:1300px; font-size:21px;"> <h1 style="color:pink;font-size: 50px;">Total de Seguidores</h1></div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center ; position:absolute; top:340px; left:1300px; font-size:21px;"> <h1 style="color:pink;font-size: 50px;">Nuevos Seguidores</h1></div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center ; position:absolute; top:440px; left:1300px; font-size:21px;"> <h1 style="color:pink;font-size: 50px;">Unfollows</h1></div>
        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>        
    </div>

    <div class="page-5">
        <!--primer post-->
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:420px; left:50px; font-size:21px; width:300px; height:220px; overflow:hidden; border:1px solid #ccc; padding:10px; box-sizing:border-box;"><img src="{{$imageSrcMayorAlcance1}}" style="max-width:100%; max-height:100%;" alt="Image"></div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:180px; left:50px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de Post : {{$datos['TopPost'][0]['type_post']}}</div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:240px; left:50px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Fecha del Post : {{$datos['TopPost'][0]['created_time']}}</div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:300px; left:50px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de publicación : {{$datos['TopPost'][0]['story']}}</div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:180px; left:280px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">{{$sumatotalinteraccionespost1}}</div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:240px; left:280px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">{{$datos['TopPost'][0]['total_reacciones']}}</div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:300px; left:280px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">{{$datos['TopPost'][0]['comments_count']}}</div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:360px; left:280px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">{{$datos['TopPost'][0]['share_count']}}</div>
        ...
        <!--segundo post-->
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:600px; left:900px; font-size:21px; width:300px; height:220px; overflow:hidden; border:1px solid #ccc; padding:10px; box-sizing:border-box;"><img src="{{$imageSrcMayorAlcance2}}" style="max-width:100%; max-height:100%;" alt="Image"></div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:430px; left:900px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de Post : {{$datos['TopPost'][1]['type_post']}}</div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:460px; left:900px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Fecha del Post : {{$datos['TopPost'][1]['created_time']}}</div>
        <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:520px; left:900px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de publicación : {{$datos['TopPost'][1]['story']}}</div>
    ...
    <div class="page-6">
        <div style="position:relative; left:600px;">
            <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:420px; left:50px; font-size:21px; width:300px; height:220px; overflow:hidden; border:1px solid #ccc; padding:10px; box-sizing:border-box;"><img src="{{$imageSrcCompartido}}" style="max-width:100%; max-height:100%;" alt="Image"></div>
            <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:180px; left:50px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de Post : {{$datos['getMostSharedPost']['type_post']}}</div>
    ...
    <div class="page-7">
        <div style="position:relative; left:600px;">
            <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:420px; left:50px; font-size:21px; width:300px; height:220px; overflow:hidden; border:1px solid #ccc; padding:10px; box-sizing:border-box;"><img src="{{$imageSrcComentario}}" style="max-width:100%; max-height:100%;" alt="Image"></div>
            <div style="color: rgb(0, 0, 0) !important; text-align:center; position:absolute; top:180px; left:50px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;">Tipo de Post : {{$datos['getMostCommentsPost']['type_post']}}</div>
