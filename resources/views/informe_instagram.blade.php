...
<body>
    ...
    <div class="page-5">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesToppost0 !!}</h1></div>
    ...
    @if(isset($datos['TopPost'][1]))
        <div class="page-5">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesToppost1 !!}</h1></div>
            <div style="position:absolute; top:240px; left:750px; font-size:21px; width:300px; padding:10px; box-sizing:border-box;"><h1 style="color:white;font-size: 50px;">{{$sumatotalinteraccionespost1}}</h1></div>
    ...
    <div class="page-6">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostshared0 !!}</h1></div>
    ...
    @if(isset($datos['getMostSharedPost'][1]))
        <div class="page-6">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostshared1 !!}</h1></div>
    ...
    <div class="page-7">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostcomments0 !!}</h1></div>
    ...
    @if(isset($datos['getMostCommentsPost'][1]))
        <div class="page-7">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostcomments1 !!}</h1></div>
    ...
    <div class="page-10">
        ...
        <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostsaved0 !!}</h1></div>
    ...
    @if(isset($datos['getMostSavedPost'][1]))
        <div class="page-10">
            ...
            <div style="position:absolute; top:900px; left:90px; font-size:21px; width:500px; padding:10px; box-sizing:border-box;"><h1 style="color:black;font-size: 20px;">{!! $contenidoConImagenesMostsaved1 !!}</h1></div>
