...
<body>
    ...
    <div class="page-3">
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center ; position:absolute; top:300px; left:800px; font-size:21px;"> <h1 style="color:white;font-size:50px">{{$datos['allImage']}} Total de Imagenes</h1></div>
        ...
        <div style="color: rgb(0, 0, 0) !important; text-align:center ; position:absolute; top:540px; left:800px; font-size:21px;"> <h1 style="color:white;font-size:50px">{{$datos['allScope']}} Alcance</h1></div>
